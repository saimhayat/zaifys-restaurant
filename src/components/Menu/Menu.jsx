  ...
  return (
    ...
    <article ref={ref} className="menu-card reveal">
      ...
      <div className="menu-card__image">
        ...
        <img src={item.image} alt={item.name} loading="lazy" width="400" height="280" />
      ...
      <div className="menu-card__body">
        ...
        <button className="menu-card__order" aria-label={`Order ${item.name}`}>

          <span>Order Now</span>

          <svg className="menu-card__order-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    <section id="menu" className="menu section-padding">
      ...
      <div className="container">
        ...
        <div ref={headRef} className="section-head center reveal">
          ...
          <h2 className="section-heading">Five cuisines, one kitchen, no compromise</h2>

          <p className="section-sub">

            From smoky coal-grilled BBQ to wok-tossed Chinese and hand-cut

            steaks — a menu built to satisfy every craving at the table.
